...
const page = () => {
  return (
     ...
     <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 bg-red-200">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
      <Image className="w-44 h-44 md:w-38 rounded-lg mx-auto " src="/rehan.jpg" alt="" width="384" height="512" />       
